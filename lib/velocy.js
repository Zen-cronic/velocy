...
class Router {
  ...
  async handleRequest(nativeReq, nativeRes) {
    ...
    // console.log("routeHandlersLength: ", routeHandlersLength);
    //   console.log("routeHandlerFunctions: ", routeHandlerFunctions);

    // for (let i = 0; i < routeHandlersLength; i++) {
    //   const currFunc = routeHandlerFunctions[i];
    //   // if (typeof currFunc === "function" ) {
    //   if (typeof currFunc === "function" && i !== routeHandlersLength ) {
    //     await currFunc(nativeReq, nativeRes, () => routeHandlerFunctions[i+1](req,res, routeHandlerFunctions[i+2](req,res) ));
    //       // await currFunc(nativeReq,nativeRes)
    //   } else {
    //     res.writeHead(404);
